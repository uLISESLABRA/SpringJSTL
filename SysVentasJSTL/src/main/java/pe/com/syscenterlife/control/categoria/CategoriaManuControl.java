 ...
 */
package pe.com.syscenterlife.control.categoria;
...
import pe.com.syscenterlife.servicio.categoria.CategoriaServicioI;
 ...
 */
@Controller
public class CategoriaManuControl {

    @Autowired
    private MessageSource messageSource;
    @Autowired
    CategoriaServicioI categoriaServicioI;

    
    Logger logger = Logger.getLogger(CategoriaManuControl.class.getName());
...
public ModelAndView inicioCategoria(Locale locale, Map<String,Object> model){
    ...
    return new ModelAndView("categoria/manufactura/mainManufactura");
}
...
public  ModelAndView buscarEntidad(Locale locale, Map<String,Object> model, HttpServletRequest r){
 ...
 @RequestMapping(value = {"/elimCategoria" }, method = RequestMethod.GET)
    ...
    return new ModelAndView("categoria/manufactura/formManufactura");
} 
